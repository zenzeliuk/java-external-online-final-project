INSERT INTO shop.item (id, count, price, name, image)
...
INSERT INTO shop.brand (id, name)
VALUES (1, 'Acer'),
       (2, 'Asus'),
       (3, 'Apple'),
       (4, 'MSI');

INSERT INTO shop.category (id, name)
VALUES (1, 'Ноутбуки');

INSERT INTO shop.color (id, name)
VALUES (1, 'Чорний'),
       (2, 'Сірий'),
       (3, 'Синій');

INSERT INTO shop.item_details (item_id, brand_id, category_id, color_id)
VALUES (1, 1, 1, 1),
       (2, 2, 1, 1),
       (3, 3, 1, 2),
       (4, 2, 1, 2),
